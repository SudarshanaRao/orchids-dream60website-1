                  ...
                  <CardContent className="p-4 space-y-2">
                    ...
                    <div className="text-sm text-purple-900 flex items-center gap-2">
                      ...
                      {selectedTransaction.paymentDetails?.vpa && (
                        <div className="text-xs text-emerald-700 font-bold bg-emerald-50 px-2 py-1.5 rounded-lg mt-1 border-2 border-emerald-200/50 flex items-center gap-2 w-fit shadow-sm">
