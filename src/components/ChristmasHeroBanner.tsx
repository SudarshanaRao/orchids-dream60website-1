  ...
  return (
      <section className="relative w-full h-[50vh] lg:h-[75vh] overflow-hidden bg-[#0a1a2f]">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          >
            <source 
              src="/sankranti_banner_large.mp4" 
              type="video/mp4" 
            />
          </video>
        ...
        {/* Main Content Area */}
        <div className="relative z-30 h-full max-w-[1440px] mx-auto px-4 sm:px-12 md:px-20 lg:px-24 flex flex-col items-center justify-center pb-8 sm:pb-12 lg:pb-0">
          <motion.div
          ...
          >
            ...
            <div className="mb-6">
              ...
              >
                Happy Sankranti <span className="text-yellow-400">2026!</span>
              </motion.h1>
              <motion.p 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                May this harvest festival bring you abundance, joy, and incredible wins. 
                Fly high with the kites of success at Dream60!
              </motion.p>
            </div>
