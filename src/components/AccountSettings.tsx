    ...
    return (
      <div className="min-h-screen bg-white relative overflow-hidden">
        ...
        <div className="flex items-center justify-center min-h-screen relative z-10 px-4">
            ...
            >
              {/* Premium Auction-Themed Loading Animation */}
              <div className="relative w-32 h-32 mx-auto">
                {/* Spinning outer specialized ring */}
                <motion.div
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-center gap-1.5">
                  <span className="text-purple-600 text-sm font-semibold tracking-wider uppercase">Loading Account</span>
