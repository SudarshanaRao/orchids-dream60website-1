  ...
  const whatsNewSteps: TutorialStep[] = [
      {
        ...
        description: 'Win amazing prizes with just ₹60! Entry fees are randomly generated by the system for each auction. Pay your fee, place bids in 4 rounds, and compete to win prizes worth up to ₹3,50,000.',
